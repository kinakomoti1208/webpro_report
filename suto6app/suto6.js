...
let moveList = [
    ...
    { id: 33, name: "弱アクセルスピンナックル", startup: 21, duration: "21〜24", stiffness: 16, hit: 2, block: -3, damage: 800, comment: "コンボ技" },
    { id: 34, name: "中アクセルスピンナックル", startup: 24, duration: "24〜27", stiffness: 16, hit: 3, block: -2, damage: 800, comment: "ほぼ使わん" },
    { id: 35, name: "強アクセルスピンナックル", startup: 28, duration: "28〜31", stiffness: 17, hit: 5, block: 3, damage: 800, comment: "玉抜け技。結構当たってくれる" },
    { id: 36, name: "ODアクセルスピンナックル", startup: 25, duration: "25〜28", stiffness: 17, hit: 7, block: -2, damage: 800, comment: "密着で打つと表裏で鬼強い" },
    { id: 37, name: "キャノンストライク", startup: 13, duration: "13〜23", stiffness: 12, hit: 0, block: -6, damage: 600, comment: "キャミィの要。これだけは覚えろ" },
    { id: 38, name: "ODキャノンストライク", startup: 13, duration: "13〜22", stiffness: 12, hit: 0, block: -3, damage: 800, comment: "ここからSA1or3に繋がる" },
    { id: 39, name: "スピンドライブスマッシャー", startup: 9, duration: "9〜19", stiffness: 38, hit: "ダウン", block: -24, damage: 2000, comment: "運びが強い。結構な頻度で使用する" },
    { id: 40, name: "キラービースピン", startup: 13, duration: "13〜21", stiffness: 37, hit: "ダウン", block: -24, damage: 3000, comment: "使い方が結構むずい" },
    { id: 41, name: "デルタレッドアサルト", startup: 9, duration: "9〜23", stiffness: 34, hit: "ダウン", block: -33, damage: 4000, comment: "CAで500ダメージ追加" },
];
